      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <p className="text-red-700 mt-2">
            Local storage is not available. Client-side caching is disabled.
            Next.js server-side caching is still active.
          </p>
        </div>
      </div>
    )
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Monitor and control your hybrid caching strategy
          </p>
        </div>
      ...
      <div className="bg-white border rounded-lg p-6">
        ...
        <div className="text-sm space-y-2 text-gray-700">
          <div><strong>Strategy:</strong> Hybrid (Client + Next.js Server)</div>
          <div><strong>Client TTL:</strong> 5-60 minutes (varies by data type)</div>
          <div><strong>Server Cache:</strong> Variable (5min - 1hr)</div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-blue-800">
                This interface manages client-side localStorage cache only. 
                Next.js server-side caching is handled automatically and provides 
                additional performance benefits across all users.
              </p>
            </div>
          </div>
        </div>
